...
$('.map-area').each(function(){
  ...
  pointArray1 = new google.maps.MVCArray(taxiData);

  heatmap1 = new google.maps.visualization.HeatmapLayer({data: pointArray1});
...
function setLegendGradient() {
    ...
    $('.legendGradient-area').css('background', '-webkit-linear-gradient' + gradientCss);
    $('.legendGradient-area').css('background', '-moz-linear-gradient' + gradientCss);
    $('.legendGradient-area').css('background', '-o-linear-gradient' + gradientCss);
    $('.legendGradient-area').css('background', 'linear-gradient' + gradientCss);
}

function setLegendLabels() {
    google.maps.event.addListenerOnce(map, 'tilesloaded', function() {
        var maxIntensity = heatmap['gm_bindings_']['data'][158]['kd']['D'];
        var legendWidth = $('.legendGradient-area').outerWidth();
